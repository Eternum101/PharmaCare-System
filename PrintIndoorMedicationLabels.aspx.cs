...
namespace PharmaCare
{
    public partial class PrintIndoorMedicationLabels : System.Web.UI.Page
    {
        ...
        private DataTable GetData()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("Select PrescriptionID,PatientID,DoctorID,DrugName,Date,PatientName,PatientType,Dose,Frequency,startdate,enddate,Prescriptiondetails from PharmaCare_Master where PrescriptionId=" + TextBox1.Text + " and PatientType='IN'"))
                {
                    cmd.Connection = con;
