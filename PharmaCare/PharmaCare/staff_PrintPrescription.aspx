<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="staff_PrintPrescription.aspx.cs" Inherits="PharmaCare.staff_PrintPrescription" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentContainer" runat="server">
     <div>
        <!-- Page Heading -->
        <h1 class="">Print Prescription</h1>
    </div>
